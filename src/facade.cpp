...
void Facade::add_test_objects()
{
  ...
  // polygon_coord_list.push_back(0); polygon_coord_list.push_back(20); polygon_coord_list.push_back(1);
  // polygon_coord_list.push_back(20); polygon_coord_list.push_back(20); polygon_coord_list.push_back(1);
